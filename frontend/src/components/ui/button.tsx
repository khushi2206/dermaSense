...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-primary-dark text-white shadow-elevated hover:brightness-110 hover:scale-[1.01] active:scale-[0.99] focus-visible:ring-primary",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-white/30 bg-white/5 text-white hover:bg-white/15 focus-visible:ring-primary",
        secondary:
          "border border-white/30 bg-white/5 text-white hover:bg-white/15 focus-visible:ring-primary",
